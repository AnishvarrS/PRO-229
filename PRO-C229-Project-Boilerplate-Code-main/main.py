...
def find_hash(original_hash):
    word_file = open("E:/Whitehatjunior/Module 5/PROJECTS/PRO-C229-Project-Boilerplate-Code-main/PRO-C229-Project-Boilerplate-Code-main/words.txt","r")
    ...
    for i in word_file:
        flag = False
        temp_word = i.replace('\n', '')
        temp_charecter = list(set(temp_word))
        for i in temp_charecter:
